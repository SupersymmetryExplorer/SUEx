...
//
//  -- IKNOWL = 1:  	some warning/error messages are collected in the suex.out file
...
//  ERRMESS: which provides a useful set of warning/error message flags, that are automatically written in the output file suex.out:
//
...
susy (int iknowl, int input, int ichoice[], double errmess[]) {
    ...
    do {
        ...
        do {
            ...
            if (ichoice[1] == 0) {
                ...
                do {
                    ...
                    if (ichoice[6] == 0) {
                        ...
                        } while (fabs (errhu) > errstop && fabs (errhd) > errstop);
                    ...
                    // consistent mu, b from ewsb conditions
                        ...
                        if (ichoice[5] == 1) {
                            ...
                            } while (!(fabs (errmu) < 5.e-5 && ma2 > 0.0 && rmu2 > 0.0 || ifix == 20));
            ...
            if (ichoice[1] == 2 && irge == irgmax) {
                ...
                repeat_high_scale_run = true;
            }
        } while (repeat_high_scale_run);
    ...
    if (ichoice[1] == 10) {
        fprintf (fpout, "\n        SUEX 2.3 OUTPUT: MSUGRA CASE");
        fprintf (fpout, "\n        ------------------------------\n");
    } else if (ichoice[1] == 11) {
        fprintf (fpout, "\n		 SUEX 2.3 OUTPUT: GMSB CASE");
        fprintf (fpout, "\n		 ----------------------------\n");
    } else if (ichoice[1] == 12) {
        fprintf (fpout, "\n		 SUEX 2.3 OUTPUT: AMSB CASE");
        fprintf (fpout, "\n		 ----------------------------");
    } else {
        fprintf (fpout, "\n		 SUEX 2.3 OUTPUT: pMSSM CASE");
        fprintf (fpout, "\n		 -----------------------------\n");
    }
